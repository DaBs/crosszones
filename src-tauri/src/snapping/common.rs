...
pub fn calculate_window_rect(
    ...
    match action {
        ...
        LayoutAction::TopLeftNinth => WindowRect {
            x: 0,
            y: 0,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::TopCenterNinth => WindowRect {
            x: screen.width / 3,
            y: 0,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::TopRightNinth => WindowRect {
            x: 2 * screen.width / 3,
            y: 0,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::MiddleLeftNinth => WindowRect {
            x: 0,
            y: screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::MiddleCenterNinth => WindowRect {
            x: screen.width / 3,
            y: screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::MiddleRightNinth => WindowRect {
            x: 2 * screen.width / 3,
            y: screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::BottomLeftNinth => WindowRect {
            x: 0,
            y: 2 * screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::BottomCenterNinth => WindowRect {
            x: screen.width / 3,
            y: 2 * screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        },
        LayoutAction::BottomRightNinth => WindowRect {
            x: 2 * screen.width / 3,
            y: 2 * screen.height / 3,
            width: screen.width / 3,
            height: screen.height / 3,
        ...
        LayoutAction::TopLeftEighth => WindowRect {
            x: 0,
            y: 0,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::TopCenterLeftEighth => WindowRect {
            x: screen.width / 4,
            y: 0,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::TopCenterRightEighth => WindowRect {
            x: 2 * screen.width / 4,
            y: 0,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::TopRightEighth => WindowRect {
            x: 3 * screen.width / 4,
            y: 0,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::BottomLeftEighth => WindowRect {
            x: 0,
            y: screen.height / 2,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::BottomCenterLeftEighth => WindowRect {
            x: screen.width / 4,
            y: screen.height / 2,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::BottomCenterRightEighth => WindowRect {
            x: 2 * screen.width / 4,
            y: screen.height / 2,
            width: screen.width / 4,
            height: screen.height / 2,
        },
        LayoutAction::BottomRightEighth => WindowRect {
            x: 3 * screen.width / 4,
            y: screen.height / 2,
            width: screen.width / 4,
            height: screen.height / 2,
